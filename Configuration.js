...
function getEndpoints(deviceAddress, endpoints)
{
    ...
    endpoints.addEndpoint("2", "Fire Alarm ", endpointType.iasSensor, iasEndpointSubType.alarmInput);
    endpoints.addEndpoint("3", "High Temperature Alarm ", endpointType.iasSensor, iasEndpointSubType.alarmInput);
